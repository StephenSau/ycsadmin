...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: "http://fs.ycs.com/upload4Uedit.htm"
        ...
        // DISABLE 'simpleupload' and 'wordimage'
        , toolbars: [[
            'fullscreen', 'undo', 'redo', '|', 'pasteplain', '|',
        ...
        ,initialStyle:'p{line-height:1.5em; font-size: 14px}'//编辑器层级的基数,可以用来改变字体等
