...
app.controller('faqCtrl', ['$scope', 'ycsUtil', 'ycsApi', 'Notification', '$modal', function (sc, ycsUtil, ycsApi, Notification, $modal) {
  sc.loadingGrid = true;
...
// Modal: 常见问题
app.controller('faqModalCtrl', ['$scope', 'predefInfo', '$modalInstance', 'ycsApi', 'ycsUtil', 'Notification', '$filter', function(sc, predefInfo, $modalInstance, ycsApi, ycsUtil, Notification, $filter){
